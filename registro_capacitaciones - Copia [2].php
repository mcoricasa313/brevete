...
for($i=1;$i<14;$i++){
  ...
  $insertSQL = sprintf("INSERT INTO registro_capacitacion (doc_identidad, id_curso, nota, curso_inicio, curso_fin, local, horas_practica, nota_practica, fecha_practica,codigo_certificado) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       //GetSQLValueString($_POST['id_capacitacion'], "int"),
...
$totalPages_Recordset_capacitacion = ceil($totalRows_Recordset_capacitacion/$maxRows_Recordset_capacitacion)-1;$maxRows_Recordset_capacitacion = 10;
$pageNum_Recordset_capacitacion = 0;
if (isset($_GET['pageNum_Recordset_capacitacion'])) {
  $pageNum_Recordset_capacitacion = $_GET['pageNum_Recordset_capacitacion'];
}
...
<div class="box" id="box">
 ...
 <h1>Agregar Curso</h1>
 <form id="form3" name="form3" method="POST" action="insertar_cursos.php">
   <br />
