...
$query_certificados = "SELECT * FROM certificados a, postulantes b, tramite c WHERE a.postulante=b.num_documento and b.id_tramite=c.id_tramite and a.estado='P'";
...
<body>
<form id="form1" name="form1" method="post" action="reporte2.pdf.php">
  <table width="800" border="0" cellspacing="0" cellpadding="3">
    <tr>
      <th scope="col"><table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <th bgcolor="#999999" scope="col"> Certificados Generados</th>
        </tr>
        <tr>
              ...
              <td width="99%" height="200" colspan="5" align="left" bgcolor="#8F8F8F"><table width="100%" border="0" cellspacing="0" cellpadding="8">
                <tr>
                  <th scope="col"> <table width="100%" border="0" cellspacing="0" cellpadding="0" style="overflow:scroll" height="100">
                    <tr>
                      <td valign="top"><div style="overflow:scroll;height:300px;width:1400px">
