...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO usuarios (ds_usuario, ds_clave, st_activo, st_nivel, ds_nombres) VALUES (%s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['ds_usuario'].$_POST['textfield4'], "text"),
                ...
                <table width="81%" border="0" cellspacing="5" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <th width="43%" align="left" class="parrafo_negro" scope="col"><label for="textfield4"></label>
                      ...
                      <input name="textfield4" type="text" id="textfield4" value="<?php echo $row_MaximoID['MAX(id_usuario)']+1; ?>" readonly="readonly" /></th>
                  ...
                  <tr>
                    ...
                    <td colspan="2" align="left"><label for="ds_usuario"></label>
                      ...
                      <input name="ds_usuario" type="text" id="ds_usuario" size="35" onkeypress="return soloLetras(event)"/></td>
                  ...
                  <tr>
                    ...
                    <td align="left"><label for="ds_clave"></label>
                      ...
                      <input type="password" name="ds_clave" id="ds_clave"  onkeypress="return soloNumeros(event)"/></td>
                  ...
                  <tr>
                    ...
                    <td colspan="2" align="left"><label for="ds_nombres"></label>
                      ...
                      <input name="ds_nombres" type="text" id="ds_nombres" size="35" onkeypress="return soloLetras(event)" /></td>
              ...
              <th align="left" scope="col"><fieldset>
                ...
                <table width="100%" border="0" cellspacing="5" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <input type="radio" name="st_nivel" id="st_nivel" value="a"/>

                    <label for="st_nivel">Administrador</label>
                  ...
                  <tr>
                    ...
                    <td class="parrafo_negro"><input type="radio" name="st_nivel" id="st_nivel" value="p"/>
            ...
            <tr>
              ...
              <th scope="col"><table width="100%" border="0" cellspacing="5" cellpadding="0">
                ...
                <tr>
                  ...
                  <th scope="col"><input name="button3" type="submit" class="btn_numeros" id="button3" value="Grabar" /></th>

                </tr>

                <tr>

                  <td><input name="button4" type="button" class="btn_numeros" id="button4" value="Cancelar" /></td>
          ...
          <td colspan="3" bgcolor="#E2E2E2"><table width="100%" border="0" cellspacing="0" cellpadding="8">
            ...
            <tr>
              ...
              <th scope="col"><table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#DFDFDF">
                ...
                <tr class="parrafo_negro">
                   ...
                   <td align="center" bgcolor="#FFFFFF" class="parrafo_negro"><a href="lista_usuarios_modificar.php?dato=<?php echo $row_lista_usuarios['id_usuario']; ?>"><img src="images/draw21.png" width="20" height="20" /></a></td>

                   <td align="center" bgcolor="#FFFFFF" class="parrafo_negro"><a href="eliminar_usuarios.php?id_usuario=<?php echo $row_lista_usuarios['id_usuario']; ?>"><img src="images/cancel.png" width="20" height="20" /></a></td>
            ...
            <?php } while ($row_lista_usuarios = mysql_fetch_assoc($lista_usuarios)); ?>
                ...
                <tr>
                  ...
                  <td colspan="8" bgcolor="#990000" align="left"><?php echo $_GET['mensaje'];?></td>
